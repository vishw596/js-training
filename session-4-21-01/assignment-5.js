...
console.log(c1.getCount()); // logs 10 as each object has count variable declared on line 3 which is initialized with 10 and getCount is called on c1 object so inside the getCount() function this will point to the c1 object
